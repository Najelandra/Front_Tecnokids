...
import styles3 from '../../styles/intro/Terms.module.css'
...
function Title1(params) {
    return (
        <div
            ...
            <br></br>
            <h1 style={{}}>
                POLÍTICA DE PRIVACIDAD PLATAFORMA TECNOKIDS
            </h1>
        </div>
    )
}
    ...
    return (
        <section>
            ...
            <ol style={{
                ...
                <li>
                    Sitio Web: <a href="https://www.tecnokids.com.co/" target="_blank">https://www.tecnokids.com.co/</a>
                </li>
            </ol>
...
function Header() {
    return (
        <div
            ...
            <div className={styles3.column6}>

                <img
                    src={'/svg/logo-header.svg'}
                    alt="Logo"
                    className={styles3.imglogo}/>

            </div>
            <div
                className={styles3.column6}
                style={{
                'paddingTop': '1.5vw'
            }}>
            ...
            <div
                ...
                <a href="/" className={styles3.botoncitosheader}>
                    INICIO
                </a>
          ...
          {/**  */}
            <div
                ...
                <div >
                    <div >
                        <a href="/intro/login" className={styles3.btn1}>
